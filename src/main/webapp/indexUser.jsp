    ...
    <body>
        ...
        <footer>
            <div class="container" style="background-color:#f1f1f1">
                <a href="historyOrderAction">View history orders</a>
                </br>${sessionScope.inforUser.name}-<a href="loadListAction">View list product</a> - <a href="listCartAction?action=view">View shopping cart</a> 
